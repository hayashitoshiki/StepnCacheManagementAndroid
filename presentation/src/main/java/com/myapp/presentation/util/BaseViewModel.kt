package com.myapp.composesample.util.base
 ...
 *
 */
abstract class BaseViewModel  <UiState : BaseContract.State,
        Effect : BaseContract.Effect,
        Event : BaseContract.Event> : ViewModel() {
